                    ...
                    (function () {
                        ...
                        var e = t((function (t, e) {
                                            ...
                                            return l.parse = function (t) {
                                                ...
                                                l.startOf = function (t, o) {
                                                    var h = this,
                                                        ...
                                                        M = function (t, e) {
                                                            return p.w(h.toDate() [t].apply(h.toDate('s'), (c ? [
                                                                0,
                                                                0,
                                                                0,
                                                                0
                                                ...
                                                l.$set = function (s, o) {
                                                    var h,
                                                        ...
                                                        d = 'set' + (this.$u ? 'UTC' : ''),
                                                        l = (h = {
                                                        }, h[i] = d + 'Date', h[f] = d + 'Date', h[a] = d + 'Month', h[u] = d + 'FullYear', h[r] = d + 'Hours', h[n] = d + 'Minutes', h[e] = d + 'Seconds', h[t] = d + 'Milliseconds', h) [c],
                                                ...
                                                l.add = function (t, o) {
                                                    ...
                                                    if (c === s) return d(7);
                                                    var l = (f = {
                                                        }, f[n] = 60000, f[r] = 3600000, f[e] = 1000, f) [c] || 1,
                                                ...
                                                l.diff = function (t, f, h) {
                                                    var c,
                                                        d = p.p(f),
                                                        l = v(t),
                                                        M = 60000 * (l.utcOffset() - this.utcOffset()),
                                                        $ = this - l,
                                                        m = p.m(this, l);
                                                    return m = (c = {
                                                    }, c[u] = m / 12, c[a] = m, c[o] = m / 3, c[s] = ($ - M) / 604800000, c[i] = ($ - M) / 86400000, c[r] = $ / 3600000, c[n] = $ / 60000, c[e] = $ / 1000, c) [d] || $,
                                                        h ? m : p.a(m)
                                                },
                            ...
                            n = t((function (t, e) {
                                ...
                                t.exports = (n = {
                                ...
                                }, i = /(\[[^[]*\])|([-:/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, u = {
                                }, h = [
                                    /[+-]\d\d:?(\d\d)?/,
                                    function (t) {
                                        (this.zone || (this.zone = {
                                    ...
                                    try {
                                        ...
                                        var p = h || 0,
                                            ...
                                            g = d || 0,
                                            S = M || 0;
                                        return $ ? new Date(Date.UTC(Y, v, D, p, y, g, S + 60 * $.offset * 1000)) : n ? new Date(Date.UTC(Y, v, D, p, y, g, S)) : new Date(Y, v, D, p, y, g, S)
                                    } catch (t) {
                                        return new Date('')
                                    }
                                }, function (t, e, n) {
            ...
            function (require, module, exports) {
                ...
                class o {
                        ...
                        Object.assign(this.options, t || {
                            ...
                            setTimeout((() =>{
                                this.emit('datatable.init'),
                                    this.initialized = !0,
                                this.options.plugins && Object.entries(this.options.plugins).forEach((([t,
                                                                                                           s]) =>{
                    ...
                    render(t) {
                        ...
                        if (this.headings = [
                        ], this.hasHeadings = this.head.rows.length > 0, this.hasHeadings && (this.header = this.head.rows[0], this.headings = [
                        ].slice.call(this.header.cells)), s.header || this.head && this.table.removeChild(this.table.tHead), s.footer ? this.head && !this.foot && (this.foot = e('tfoot', {
                    ...
                    paginate() {
                        ...
                        return this.searching && (e = [
                            ...
                            this.options.paging ? this.pages = e.map(((s, a) =>a % t == 0 ? e.slice(a, a + t) : null)).filter((t=>t)) : this.pages = [
                                e
                            ],
                    ...
                    search(t) {
                        return !!this.hasRows && (t = t.toLowerCase(), this.currentPage = 1, this.searching = !0, this.searchData = [
                        ], t.length ? (this.clear(), this.data.forEach(((e, s) =>{
                        ...
                        if (o.type) {
                            ...
                            if (a.length) {
                                if ('txt' === o.type || 'csv' === o.type) {
                                    ...
                                    for (h = 0; h < a.length; h++) for (i[h] = i[h] || {
                                    }, n = 0; n < s.length; n++) !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (i[h][s[n].textContent] = a[h].cells[n].textContent);
                                    l = JSON.stringify(i, o.replacer, o.space),
                                    o.download && (l = `data:application/json;charset=utf-8,${ l }`)
                                }
                                return o.download && (o.filename = o.filename || 'datatable_export', o.filename += `.${ o.type }`, l = encodeURI(l), r = document.createElement('a'), r.href = l, r.download = o.filename, document.body.appendChild(r), r.click(), document.body.removeChild(r)),
                                    l
                            }
                        }
                        return !1
                    ...
                    emit(t) {
                        ...
                        }, t in this.events != !1) for (let e = 0; e < this.events[t].length; e++) this.events[t][e].apply(this, Array.prototype.slice.call(arguments, 1))
                    }
                }
                exports.DataTable = o;
            },
